...
assignPositionToCollection.mockImplementation(() => () => ({
  metadata: { position: [0] },
}));

assignPositionToResource.mockImplementation(() => resource => ({
  ...resource,
...
assignPositionToSource.mockImplementation(() => () => ({ metadata: { position: [0, 0] } }));
